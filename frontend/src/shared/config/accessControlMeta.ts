...
export const permissionMeta: Record<string, PermissionMeta> = {
  ...
  DEPARTMENT_CREATE: { label: "부서 등록", description: "새 부서를 등록합니다.", group: "employee" },
  ...
  ATTENDANCE_SETTINGS_UPDATE: { label: "근태 기준 설정", description: "출퇴근 기준 시간을 수정합니다.", group: "attendance" },
